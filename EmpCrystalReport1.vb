...
Public Class EmpCrystalReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BOOK_STORE.EmpCrystalReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmpCrystalReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmpCrystalReport1 = New EmpCrystalReport1
        rpt.Site = Me.Site
        Return rpt
    End Function
