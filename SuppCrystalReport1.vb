...
Public Class SuppCrystalReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BOOK_STORE.SuppCrystalReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSuppCrystalReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SuppCrystalReport1 = New SuppCrystalReport1
        rpt.Site = Me.Site
        Return rpt
    End Function
