...
Public Class BookCrystalReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BOOK_STORE.BookCrystalReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBookCrystalReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BookCrystalReport1 = New BookCrystalReport1
        rpt.Site = Me.Site
        Return rpt
    End Function
